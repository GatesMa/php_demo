...
<head>
	...
	<title>首页 - 个人博客</title>
	<meta name="keywords" content="博客,个人博客,个人博客,PHP"/>
	<meta name="description" content="是PHP中文网的讲师，愿意把知识分享给大家。" />
...
<body class="home blog custom-background custom-font-enabled single-author">
	<div id="page" class="hfeed site">
		<header id="masthead" class="site-header" role="banner">
		    <hgroup>
		        <h1 class="site-title">
		            <a href="/" title="<?php echo '个人博客'; ?>" rel="home"><?php echo '个人博客'; ?></a>
		        </h1>
		        <h2 class="site-description"><?php echo '是PHP中文网的讲师，愿意把知识分享给大家。'; ?> </h2>
		    </hgroup>
